(ns netops.actor
  "NetworkProfessionalsActor — the ISCO-08 2523 community netops actor as a
  ...
  The unconditional invariant: the NetworkProfessionalsAdvisor can never
  directly commit a record the NetworkProfessionalsGovernor refuses —
...
(defn build-graph
  "Build a compiled NetworkProfessionalsActor graph. `store` implements
